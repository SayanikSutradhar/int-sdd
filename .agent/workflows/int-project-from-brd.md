...
3. Changes shall be classified as Added, Modified, Removed, or Unchanged.
...
BRD Requirement → BRD Change → Business Domain → Module → Specification → Task → Test Case → Implementation
